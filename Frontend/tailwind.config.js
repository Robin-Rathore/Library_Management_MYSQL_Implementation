...
export default {
  content: ["./index.html", "./src/**/*.{js,ts,jsx,tsx}",
                ...
                './src/Components/AuthPages/**/*.{js,ts,jsx,tsx,mdx}',
  ...
  theme: {
    extend: {
      colors: {
        ...
        PrimiaryColor : "#FFFFFF", // Light Grayish White Colour
        SecondaryColor : "#40BFFF", // Yellowish Orange
        DarkColor : "#1EB2FC", // Dark Gray Colour
      ...
      fontFamily: {
        josefin: ['"Josefin Sans"', 'sans-serif'],  // Existing custom font family
        plaster: ['"Plaster"', 'sans-serif'],       // New Plaster font family
      },
      fontWeight: {
